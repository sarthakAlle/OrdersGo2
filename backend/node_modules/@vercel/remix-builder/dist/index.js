...
module.exports = config;`;
  ...
  const serverBundlesRespected = (0, import_fs2.existsSync)(
    (0, import_path3.join)(entrypointFsDirname, serverBundles[0].serverBuildPath)
  );
  ...
  const [staticFiles, buildAssets, ...functions] = await Promise.all([
    ...
    ...serverBundles.map((bundle) => {
      ...
      const serverBuildPath = (0, import_path3.join)(entrypointFsDirname, bundle.serverBuildPath);
